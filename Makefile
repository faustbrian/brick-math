...
test\:unit\:native: build
	$(compose_command) env CALCULATOR=Native composer test:unit

test\:unit\:bcmath: build
	$(compose_command) env CALCULATOR=BCMath composer test:unit

test\:unit\:gmp: build
	$(compose_command) env CALCULATOR=GMP composer test:unit
